...
1. Bundled plugins: ``plugins/model-providers/<name>/`` (shipped with prostor-agent)
2. User plugins: ``$PROSTOR_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$PROSTOR_HOME/plugins/model-providers/`` can override
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    # multiple PROSTOR_HOME profiles don't alias each other.
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$PROSTOR_HOME/plugins/model-providers/<name>/``
    ...
    # 1. Bundled plugins — shipped with prostor-agent.
    ...
    # 2. User plugins — under $PROSTOR_HOME/plugins/model-providers/<name>/.
