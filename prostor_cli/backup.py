...
from prostor_constants import get_default_hermes_root, get_prostor_home, display_prostor_home
...
def restore_cron_jobs_if_emptied(
    ...
    Args:
        ...
        prostor_home: Override for the Hermes home directory (tests).
...
def create_pre_update_backup(
    ...
    """
    hermes_root = prostor_home or get_default_hermes_root()
    if not hermes_root.is_dir():
        return None
