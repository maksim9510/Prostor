"""Prostor middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "prostor.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "prostor.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Prostor sends them.
    """
...
def _has_middleware(kind: str) -> bool:
    from prostor_cli.plugins import has_middleware
