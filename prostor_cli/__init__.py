"""
Prostor CLI - Unified command-line interface for Prostor Agent.

Provides subcommands for:
- prostor chat          - Interactive chat (same as ./prostor)
- prostor gateway       - Run gateway in foreground
- prostor gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `prostor setup` on a fresh Pi.
