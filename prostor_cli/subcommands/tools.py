"""``prostor tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'prostor tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # prostor tools list [--platform cli]
    ...
    # prostor tools disable <name...> [--platform cli]
    ...
    # prostor tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `prostor tools` runs after you pick a provider that\n"
