...
Prostor gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Prostor to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Prostor needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Prostor gateway in another terminal:")
    print("         prostor gateway")
    print()
