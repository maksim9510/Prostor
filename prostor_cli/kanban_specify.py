...
Used by ``prostor kanban specify [task_id | --all]``. Takes a task that
...
PROSTOR_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("PROSTOR_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Prostor Agent board.
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=PROSTOR_KANBAN_SPECIFY_MAX_TOKENS,
