...
8. **Verify API keys BEFORE firing.** External APIs (TTS, image-gen,
   image-to-video) need keys in `${PROSTOR_HOME:-~/.prostor}/.env` or the user's secret store.
