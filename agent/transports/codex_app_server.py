...
projection into Prostor' display, approval bridging, transcript projection into
...
"codex_app_server"`. Prostor' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("PROSTOR_KANBAN_TASK"):
            kanban_db = spawn_env.get("PROSTOR_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "PROSTOR_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("PROSTOR_HOME", os.path.expanduser("~/.prostor")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "prostor",
        client_title: str = "Prostor Agent",
