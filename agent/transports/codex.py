...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Prostor's web-provider config and
        ...
        # native search engine for xAI sessions instead of Prostor's
        # configured web provider (Tavily/etc.), and those results bypass
        # Prostor's tool-trace / citation plumbing (they arrive baked into the
