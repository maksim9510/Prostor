...
def store(tmp_path, monkeypatch):
    ...
    ~/.prostor/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at prostor_state import time, before pytest's PROSTOR_HOME monkeypatch
    fires — the autouse fixture's PROSTOR_HOME override doesn't help here.)
    """
