"""Tests for _setup_feishu() in prostor_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("prostor_cli.config.save_env_value", side_effect=mock_save), \
         patch("prostor_cli.config.get_env_value", side_effect=mock_get), \
         patch("prostor_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("prostor_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("prostor_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("prostor_cli.cli_output.print_header"), \
         patch("prostor_cli.cli_output.print_info"), \
         patch("prostor_cli.cli_output.print_success"), \
         patch("prostor_cli.cli_output.print_warning"), \
         patch("prostor_cli.cli_output.print_error"), \
