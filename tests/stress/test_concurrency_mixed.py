...
def worker_loop(worker_id: int, prostor_home: str, result_file: str) -> None:
...
def reclaimer_loop(prostor_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="prostor_mixed_stress_")
    print(f"PROSTOR_HOME = {home}")
