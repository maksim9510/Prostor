"""Test the platform-branched PTY bridge import in prostor_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from prostor_cli.win_pty_bridge import WinPtyBridge
    ...
    from prostor_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from prostor_cli.pty_bridge import PtyBridge as PosixBridge
    from prostor_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    assert "from prostor_cli.win_pty_bridge import" in src
    assert "from prostor_cli.pty_bridge import" in src
