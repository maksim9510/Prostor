"""Tests for the specifier module + `prostor kanban specify` CLI surface.
...
from prostor_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `prostor kanban …` argparse surface directly."""
