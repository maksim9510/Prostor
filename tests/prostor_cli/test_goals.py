"""Tests for prostor_cli/goals.py — persistent cross-turn goals."""
...
def prostor_home(tmp_path, monkeypatch):
    """Isolated PROSTOR_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves PROSTOR_HOME.
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from prostor_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from prostor_cli.goals import judge_goal
...
class TestGoalManager:
    def test_no_goal_initial(self, prostor_home):
    ...
    def test_set_then_status(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_clear(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, prostor_home):
    ...
    def test_evaluate_after_turn_done(self, prostor_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, prostor_home):
        from prostor_cli import goals
        from prostor_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, prostor_home):
    ...
    def test_evaluate_after_turn_inactive(self, prostor_home):
    ...
    def test_continuation_prompt_shape(self, prostor_home):
        ...
        mgr.set("port goal command to prostor")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to prostor" in prompt
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from prostor_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, prostor_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, prostor_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from prostor_cli import goals
        from prostor_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from prostor_cli.goals import GoalState
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, prostor_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, prostor_home):
        from prostor_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, prostor_home):
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, prostor_home):
        from prostor_cli.goals import GoalManager
    ...
    def test_status_line_with_subgoals(self, prostor_home):
        from prostor_cli.goals import GoalManager
