"""Tests for the `prostor memory reset` CLI command.
...
- Profile-scoped reset (uses PROSTOR_HOME)
"""
...
class TestMemoryReset:
    """Tests for `prostor memory reset` subcommand."""
    ...
    def test_reset_profile_scoped(self, tmp_path, monkeypatch):
        """Reset should work on the active profile's PROSTOR_HOME."""
