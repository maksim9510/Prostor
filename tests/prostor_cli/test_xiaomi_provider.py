...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from prostor_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in PROSTOR_OVERLAYS
        overlay = PROSTOR_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify prostor doctor recognizes Xiaomi env vars."""
