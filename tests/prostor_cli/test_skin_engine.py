"""Tests for prostor_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from prostor_cli import skin_engine
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from prostor_cli.skin_engine import load_skin
    ...
    def test_get_branding_with_fallback(self):
        from prostor_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == "Prostor Agent"
...
class TestBuiltinSkins:
    ...
    def test_all_builtin_skins_have_complete_colors(self):
        from prostor_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("prostor_cli.skin_engine._skins_dir", lambda: skins_dir)
