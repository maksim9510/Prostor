"""Tests for the prostor-tools-as-MCP server module surface.
...
class TestModuleSurface:
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.prostor_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_expected_prostor_specific_tools_listed(self):
        """The Prostor-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `prostor chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.prostor_tools_mcp_server as m
