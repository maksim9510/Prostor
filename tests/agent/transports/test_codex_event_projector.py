"""Tests for CodexEventProjector — codex item/* events → Prostor messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Prostor' message alternation invariant."""
