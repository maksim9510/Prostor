...
def test_new_command_rotates_prostor_session_id_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["PROSTOR_SESSION_ID"] == cli.session_id
    assert get_session_env("PROSTOR_SESSION_ID") == cli.session_id
