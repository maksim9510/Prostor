...
Prostor state stays profile-scoped through PROSTOR_HOME. Host subprocesses should
...
class TestGetSubprocessHome:
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        self._container_mode(monkeypatch)
        base = tmp_path / ".prostor" / "profiles"
        ...
        monkeypatch.setenv("PROSTOR_HOME", str(base / "beta"))
