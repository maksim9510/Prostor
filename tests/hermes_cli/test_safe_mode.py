"""Tests for `prostor chat --safe-mode` — pristine troubleshooting runs.
...
troubleshooting. The Prostor equivalent:
...
class TestSafeModeEnvWiring:
    ...
    def test_safe_mode_sets_all_gates(self):
        ...
        assert os.environ.get("PROSTOR_SAFE_MODE") == "1"
...
class TestSafeModePluginDiscovery:
    """Plugin discovery must be a no-op under PROSTOR_SAFE_MODE=1."""
...
class TestSafeModeMCP:
    """_load_mcp_config must return no servers under PROSTOR_SAFE_MODE=1."""
