...
class TestHeartbeatStaleThresholds:
    ...
    def test_idle_timeout_seconds(self):
        ...
        from tools.delegate_tool import _HEARTBEAT_INTERVAL, _HEARTBEAT_STALE_CYCLES_IDLE
    ...
    def test_in_tool_timeout_seconds(self):
        ...
        from tools.delegate_tool import _HEARTBEAT_INTERVAL, _HEARTBEAT_STALE_CYCLES_IN_TOOL
