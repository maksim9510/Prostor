...
The unit tests in tests/prostor_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned prostor-writable by the
...
from prostor_cli.service_manager import S6ServiceManager
