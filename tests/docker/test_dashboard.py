...
def test_dashboard_slot_reports_up_when_enabled(
    ...
    subprocess.run(
        ["docker", "run", "-d", "--name", container_name,
         ...
         "-e", "PROSTOR_DASHBOARD_BASIC_AUTH_USERNAME=admin",
         "-e", "PROSTOR_DASHBOARD_BASIC_AUTH_PASSWORD=test-dashboard-pw",
...
def test_dashboard_insecure_env_var_no_longer_bypasses_gate(
    ...
    """``PROSTOR_DASHBOARD_INSECURE=1`` NO LONGER disables the auth gate
