...
class SessionDB:
    ...
    # With multiple prostor processes (gateway + CLI sessions + worktree agents)
    ...
    def search_sessions_by_id(
        ...
        a session id from logs, CLI output, or another Prostor surface and jump
    ...
    def delete_session_if_empty(
        ...
        and ``prostor sessions list`` output. (Pattern ported from
    ...
    def apply_telegram_topic_migration(self) -> None:
        ...
        reconciliation. Operators must be able to upgrade Prostor, keep the old
    ...
    def bind_telegram_topic(
        ...
        *,
        ...
        """Bind one Telegram DM topic thread to one Prostor session.

        A Prostor session may only be linked to one Telegram topic in MVP.
    ...
    def is_telegram_session_linked_to_topic(self, *, session_id: str) -> bool:
        """Return True if a Prostor session is already bound to any Telegram DM topic.
