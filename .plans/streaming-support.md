# Streaming LLM Response Support for Prostor Agent
...
```
PROSTOR_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("PROSTOR_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `prostor_cli/config.py` | 1 | +streaming config defaults |
...
PROSTOR_STREAMING_ENABLED=true
```
