...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateProstor: "Atualizar Prostor",
    updatingProstor: "A atualizar Prostor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Prostor (paridade com `prostor plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.prostor/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.prostor/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.prostor/skills/",
  ...
  config: {
    configPath: "~/.prostor/config.yaml",
    filters: "Filtros",
    sections: "Secções",
  ...
  achievements: {
    hero: {
      ...
      title: "Prostor Achievements",
      subtitle:
        "Distintivos colecionáveis do Prostor obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do Prostor. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Prostor",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Prostor detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Prostor analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Prostor Agent ☤",
    },
  },
  kanban: {
