...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateProstor: "Werk Prostor op",
    updatingProstor: "Besig om Prostor op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Prostor-inproppe op (`prostor plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.prostor/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.prostor/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.prostor/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Prostor-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Prostor-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Prostor meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Prostor 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Prostor skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
