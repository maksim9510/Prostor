...
import { api, PROSTOR_BASE_PATH, buildWsAuthParam } from "@/lib/api";
...
export function ChatSidebar({
  ...
  // /api/events in prostor_cli/web_server.py for the broadcast hop.
  //
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      ws = new WebSocket(
        `${proto}//${window.location.host}${PROSTOR_BASE_PATH}/api/events?${qs.toString()}`,
      );
