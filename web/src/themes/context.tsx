...
const STORAGE_KEY = "prostor-dashboard-theme";
...
const FONT_STORAGE_KEY = "prostor-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `prostor_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "prostor-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-prostor-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-prostor-theme-font", "true");
