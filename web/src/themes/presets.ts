 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `prostor_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Prostor Teal",
  description: "Classic dark teal — the canonical Prostor look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Prostor look, ported from the
 ...
 * nousnet-web's <body> is white; prostor-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Prostor Teal (Large)",
  description: "Prostor Teal with bigger fonts and roomier spacing",
