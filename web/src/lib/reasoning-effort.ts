 ...
 *
 * Values mirror prostor_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Prostor default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Prostor' default when unset). */
