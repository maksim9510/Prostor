 ...
 *
 * Plugins call window.__PROSTOR_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__PROSTOR_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__PROSTOR_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__PROSTOR_PLUGIN_SDK__ = {
    ...
    // window.__PROSTOR_SESSION_TOKEN__ directly.
    authedFetch,
