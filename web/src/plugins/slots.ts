 ...
 * `window.__PROSTOR_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Prostor brand in the top bar
 ...
 *  `window.__PROSTOR_PLUGINS__.registerSlot(...)`.
 *
