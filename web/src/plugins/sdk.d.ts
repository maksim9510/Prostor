/**
 * Prostor Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__PROSTOR_PLUGIN_SDK__`` and
 * ``window.__PROSTOR_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__PROSTOR_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``ProstorPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@prostor/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__PROSTOR_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__PROSTOR_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__PROSTOR_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface ProstorPluginSDK {
...
declare global {
  interface Window {
    __PROSTOR_PLUGIN_SDK__?: ProstorPluginSDK;
    __PROSTOR_PLUGINS__?: PluginRegistry;
  }
}
