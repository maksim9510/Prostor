#!/usr/bin/env python3
"""
SWE Runner with Prostor Trajectory Format

A runner that uses Prostor-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Prostor-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Prostor-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Prostor format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Prostor-Agent format)
# ============================================================================
...
# ============================================================================
# Mini-SWE Runner with Prostor Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Prostor-Agent's built-in execution environments
    and outputs trajectories in Prostor-Agent format.
    """
...
Complete the user's task step by step."""
        ...
        # Convert to Prostor trajectory format
        trajectory = self._convert_to_prostor_format(messages, task, completed)
...
def main(
    ...
    """
    print("🚀 Mini-SWE Runner with Prostor Trajectory Format")
    print("=" * 60)
