...
// process.env.PROSTOR_DEV_CREDITS exactly once, at import). Mutating process.env
...
vi.mock('../config/env.js', async (importOriginal) => {
  const actual = (await importOriginal()) as typeof EnvModuleNS
...
describe('StatusRule dev-credits banner (PROSTOR_DEV_CREDITS on)', () => {
