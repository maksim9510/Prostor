 ...
 *
 * Symptom: in `prostor --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@prostor/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using prostor --tui and as i type multiline my caret at the end will often ' +
