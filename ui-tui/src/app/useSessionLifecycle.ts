...
import type { ScrollBoxHandle } from '@prostor/ink'
import { evictInkCaches } from '@prostor/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.PROSTOR_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
