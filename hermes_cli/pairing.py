...
Usage:
    prostor pairing list              # Show all pending + approved users
    prostor pairing approve <platform> <code>  # Approve a pairing code
    prostor pairing revoke <platform> <user_id> # Revoke user access
...
def pairing_command(args):
    ...
    if action == "list":
        ...
        print("Usage: prostor pairing {list|approve|revoke|clear-pending}")
        print("Run 'prostor pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'prostor pairing list' to see pending codes.\n")
