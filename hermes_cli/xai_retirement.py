...
Pure logic: walks a Prostor config dict, returns issues for any reference
to a retired xAI model. No I/O, no CLI dependencies — testable in isolation
and reusable from both `prostor doctor` and a future `prostor migrate xai`.
"""
...
class RetirementIssue:
    """A reference to a retired xAI model found in a Prostor config."""
