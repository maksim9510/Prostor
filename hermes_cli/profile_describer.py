...
Used by ``prostor profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Prostor Agent kanban board.
...
Rules:
  ...
  - Never write "Prostor Agent profile" or other meta-narration.
