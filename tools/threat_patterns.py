...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.prostor/\.env|\~/\.prostor/\.env', "hermes_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.prostor/(config\.yaml|SOUL\.md)', "hermes_config_mod", "strict"),
