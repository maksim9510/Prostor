...
```bash
/cron add "every 6h" "Check the GitHub repository maksim9510/Prostor for:
- New issues opened in the last 6 hours
- New PRs opened or merged in the last 6 hours
- Any new releases

Use the terminal to run gh commands:
  gh issue list --repo maksim9510/Prostor --state open --json number,title,author,createdAt --limit 10
  gh pr list --repo maksim9510/Prostor --state all --json number,title,author,createdAt,mergedAt --limit 10
