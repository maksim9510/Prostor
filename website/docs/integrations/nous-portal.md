...
If a model is genuinely missing, [open an issue](https://github.com/maksim9510/Prostor/issues) — we surface the Portal's catalog to Prostor and gaps usually mean a routing config we can update.
