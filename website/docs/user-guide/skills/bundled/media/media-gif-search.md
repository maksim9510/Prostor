...
Set your Tenor API key in your environment (add to `~/.prostor/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/prostor-agent/blob/main/skills/media/gif-search/url)`
