...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Prostor Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.prostor/.env`:
