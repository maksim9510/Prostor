...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Prostor Agent |
| License | MIT |
...
Helper script path: `~/.prostor/skills/blockchain/evm/scripts/evm_client.py`
