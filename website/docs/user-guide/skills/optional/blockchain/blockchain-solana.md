...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Prostor Agent |
| License | MIT |
...
Helper script path: ~/.prostor/skills/blockchain/solana/scripts/solana_client.py
