...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/health/neuroskill-bci` |
...
Connect Prostor to a running [NeuroSkill](https://neuroskill.com/) instance to read
