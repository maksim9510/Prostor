...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.prostor/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.prostor/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Prostor installs package this)
