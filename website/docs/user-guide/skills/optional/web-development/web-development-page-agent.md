...
- User wants **Prostor itself to drive a browser** → use Prostor' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
