...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Prostor Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $PROSTOR_OSINT_CACHE/icij/ (default: ~/.cache/prostor-osint/icij/).
...
# Set PROSTOR_OSINT_UA=your-app/1.0 (your@email) to identify yourself
