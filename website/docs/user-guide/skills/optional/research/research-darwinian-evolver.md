...
| | |
|---|---|
| Source | Optional — install with `prostor skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Prostor Agent |
| License | MIT |
...
import upstream classes into Prostor itself.
...
Open `~/.prostor/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Prostor core.
   Custom driver scripts under `~/.prostor/skills/...` are user-side and fine.
