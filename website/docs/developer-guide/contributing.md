...
- **Profile-safe paths**: Never hardcode `~/.prostor` — use `get_prostor_home()` from `prostor_constants` for code paths and `display_prostor_home()` for user-facing messages. See [AGENTS.md](https://github.com/maksim9510/Prostor/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/maksim9510/Prostor/blob/main/LICENSE).
