...
slug: /
sidebar_position: 0
title: "Prostor Agent Documentation"
...
After installing, run `prostor setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Prostor Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Prostor safely  |
| 🧭 **[Use MCP with Prostor](/guides/use-mcp-with-prostor)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Prostor](/guides/use-voice-mode-with-prostor)** | Hands-on setup and usage patterns for Prostor voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Prostor' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Prostor                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Prostor, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Prostor, Nomos, and Psyche models
