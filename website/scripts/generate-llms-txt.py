#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Prostor docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Prostor as a Python Library", None),
        ("guides/use-mcp-with-prostor", "Use MCP with Prostor", None),
        ("guides/use-voice-mode-with-prostor", "Use Voice Mode with Prostor", None),
        ("guides/use-soul-with-prostor", "Use SOUL.md with Prostor", None),
        ("guides/build-a-prostor-plugin", "Build a Prostor Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Prostor"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Prostor Agent — Full Documentation\n",
        (
            "This file is the entire Prostor Agent documentation concatenated for LLM "
