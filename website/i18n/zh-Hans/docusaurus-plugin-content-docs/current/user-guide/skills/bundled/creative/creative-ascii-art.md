...
```bash
python3 -m pyfiglet "PROSTOR" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=PROSTOR&font=Slant" | boxes -d stone
```
