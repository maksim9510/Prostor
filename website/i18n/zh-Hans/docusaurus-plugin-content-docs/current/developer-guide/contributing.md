...
- **Profile 安全路径**：不得硬编码 `~/.prostor` — 代码路径使用 `prostor_constants` 中的 `get_prostor_home()`，面向用户的消息使用 `display_prostor_home()`。完整规则参见 [AGENTS.md](https://github.com/maksim9510/Prostor/blob/main/AGENTS.md#profiles-multi-instance-support)。
...
- 使用 [GitHub Issues](https://github.com/maksim9510/Prostor/issues)
...
提交贡献即表示您同意您的贡献将以 [MIT 许可证](https://github.com/maksim9510/Prostor/blob/main/LICENSE) 授权。