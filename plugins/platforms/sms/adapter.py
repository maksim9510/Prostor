...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Prostor gateway adapter.

    Each inbound phone number gets its own Prostor session (multi-tenant).
...
# static dict in prostor_cli/gateway.py, and the _send_sms dispatch in
