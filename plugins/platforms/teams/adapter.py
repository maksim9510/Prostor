"""
Microsoft Teams platform adapter for Prostor Agent.
...
try:
    ...
    from microsoft_teams.api.models.invoke_response import AdaptiveCardInvokeResponse, InvokeResponse
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Prostor"}),
            )
    ...
    async def _fetch_attachment_bytes(self, url: str, timeout: float = 30.0) -> bytes:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                url,
                headers={"User-Agent": "Mozilla/5.0 (compatible; ProstorAgent/1.0)"},
            )
            response.raise_for_status()
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Prostor\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.prostor/.env")
