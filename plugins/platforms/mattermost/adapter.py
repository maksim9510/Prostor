...
required — uses aiohttp which is already a Prostor dependency.
...
class MattermostAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._last_post_status: int | None = None
...
def interactive_setup() -> None:
    ...
    ``prostor_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Prostor delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # prostor_cli/setup.py::_setup_mattermost function.
