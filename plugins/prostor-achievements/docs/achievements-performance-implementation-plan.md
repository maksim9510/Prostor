# Prostor Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.prostor/plugins/prostor-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.prostor/plugins/prostor-achievements/scan_checkpoint.json`.
