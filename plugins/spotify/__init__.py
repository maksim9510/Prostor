...
``_check_spotify_available()`` — when the user has not run ``prostor auth
spotify``, the tools remain registered (so they appear in ``prostor
...
The Spotify auth flow (``prostor auth spotify``), CLI plumbing, and docs
