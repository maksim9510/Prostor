...
/*
 * Success screen. PROSTOR AGENT wordmark stays as the visual anchor
...
export default function Success() {
  ...
  return (
    <div className="prostor-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Prostor is ready</span>
          </span>
          <span aria-hidden="true">Prostor is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Prostor'}
      </Button>
