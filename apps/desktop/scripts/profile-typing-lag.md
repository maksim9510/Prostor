...
cd apps/desktop
XCURSOR_SIZE=24 PROSTOR_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/prostor-typing
# → /tmp/prostor-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/prostor-typing.before.heapsnapshot
# → /tmp/prostor-typing.after.heapsnapshot
```
