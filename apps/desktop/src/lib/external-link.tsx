...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|prostor):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.prostorDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.prostorDesktop?.openExternal?.(href)
  }
}
