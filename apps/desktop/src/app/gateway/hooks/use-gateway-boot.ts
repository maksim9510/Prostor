...
import type { RpcEvent } from '@/types/prostor'
...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Prostor...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Prostor…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Prostor gateway". resolveGatewayWsUrl
