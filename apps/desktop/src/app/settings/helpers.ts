import type { ProstorConfigRecord, ToolsetInfo } from '@/types/prostor'
...
export function getNested(obj: ProstorConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ProstorConfigRecord, path: string, value: unknown): ProstorConfigRecord {
...
function personalityOptions(config: ProstorConfigRecord): string[] {
