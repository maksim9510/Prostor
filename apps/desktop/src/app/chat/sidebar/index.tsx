...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/prostor'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('prostor:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('prostor:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
