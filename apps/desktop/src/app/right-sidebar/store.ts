...
const TAKEOVER_KEY = 'prostor.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Prostor can't clear via the API — the user
 *  sees exactly what runs instead of Prostor silently deleting their creds. */
