...
export const ru: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        title: 'Питомец',
        intro: 'Выберите анимированного питомца, который будет парить над приложением и реагировать на действия Prostor — бежать во время работы инструментов, радоваться при успехе, грустить при ошибках.',
        restartHint: 'Питомцам нужна быстрая перезагрузка. Выйдите и откройте заново.',
        on: 'Вкл',
        off: 'Выкл',
        scaleTitle: 'Размер',
        ...
        unreachable: 'Не удалось подключиться к галерее питомцев. Проверьте соединение.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      loading: 'Загрузка галереи питомцев…',
      error: 'Не удалось загрузить галерею питомцев.',
      staleBackend: 'Перезапустите Prostor для использования питомцев.',
  ...
  updates: {
    ...
    guiSkewBody: 'Бэкенд обновлён, но пакет приложения не изменён. Обновите или переустановите Prostor.',
    copy: 'Копировать',
    copied: 'Скопировано',
    done: 'Готово',
