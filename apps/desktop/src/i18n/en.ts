...
export const en: Translations = {
  ...
  updates: {
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Prostor desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Prostor updater takes over in its own window and reopens Prostor automatically when it’s done. Please don’t reopen Prostor yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Prostor reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Prostor reopens on its own.',
