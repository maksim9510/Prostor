 ...
 *
 * A public install can end up with `origin=git@github.com:maksim9510/Prostor.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/maksim9510/Prostor.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/maksim9510/Prostor'
