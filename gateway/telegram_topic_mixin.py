"""Telegram DM topic-mode mixin for GatewayRunner.

Extracted from gateway/run.py (Issue #23 god-file refactor) to isolate the
21 methods that manage Telegram private-chat topic lanes — session binding,
thread recovery, auto-rename, capability probing, and lobby routing.
...
(``self._session_db``, ``self.adapters``, ``self.config``, etc.).
"""
...
class GatewayTelegramTopicMixin:
    """Telegram DM topic-mode management — extracted from GatewayRunner."""
