...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Prostor\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "prostor@nousresearch.com",
    "prostor-audit@example.com",
    "prostor@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/prostor-agent",
                "--state", "merged",
