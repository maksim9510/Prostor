...
DEFAULT_DATASETS = [
    ...
    "NousResearch/prostor-agent-megascience-sft1",
    "NousResearch/Prostor-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Prostor-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-prostor-agent"
]
