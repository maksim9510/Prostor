#!/usr/bin/env python3
"""Build the Prostor Model Catalog — a centralized JSON manifest of curated models.
...
Prostor CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Prostor release.
